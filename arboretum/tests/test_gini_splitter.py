...
class TestGiniSplitter(unittest.TestCase):
    ...
    def test_min_leaf(self):
        ...
        x, y = x[::10], y[::10]
        w = np.ones_like(y)
        result = split(x, y, w, min_leaf=4)[:2]
